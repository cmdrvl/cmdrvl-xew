...
- P008 must not call OpenFIGI, canon, twinning, HTTP, or LLM/model runtimes during detection. Registry evidence must come from a local snapshot copied into the Evidence Pack.
